...
namespace asana.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TimePeriodBase :  IEquatable<TimePeriodBase>, IValidatableObject
    {
        /// <summary>
        ...
        public TimePeriodBase(string endOn = default(string), string startOn = default(string), PeriodEnum? period = default(PeriodEnum?), string displayName = default(string), TimePeriodCompact parent = default(TimePeriodCompact))
        {
            this.EndOn = endOn;
        ...
        {
            return this.Equals(input as TimePeriodBase);
        }

        /// <summary>
        /// Returns true if TimePeriodBase instances are equal
        /// </summary>
        /// <param name="input">Instance of TimePeriodBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TimePeriodBase input)
        {
            if (input == null)
                return false;
