...
namespace asana.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CustomFieldBase :  IEquatable<CustomFieldBase>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as CustomFieldBase);
        }

        /// <summary>
        /// Returns true if CustomFieldBase instances are equal
        /// </summary>
        /// <param name="input">Instance of CustomFieldBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CustomFieldBase input)
        {
            if (input == null)
                return false;
