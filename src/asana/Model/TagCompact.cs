...
namespace asana.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TagCompact :  IEquatable<TagCompact>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TagCompact" /> class.
        /// </summary>
        ...
        public TagCompact(string name = default(string))
        {
            this.Name = name;
        }
        ...
        {
            return this.Equals(input as TagCompact);
        }

        /// <summary>
        /// Returns true if TagCompact instances are equal
        /// </summary>
        /// <param name="input">Instance of TagCompact to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TagCompact input)
        {
            if (input == null)
                return false;
