...
namespace asana.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GoalBase :  IEquatable<GoalBase>, IValidatableObject
    {
        /// <summary>
        ...
        public GoalBase(string name = default(string), string htmlNotes = default(string), string notes = default(string), string dueOn = default(string), string startOn = default(string), string status = default(string), bool isWorkspaceLevel = default(bool), bool liked = default(bool))
        {
            this.DueOn = dueOn;
        ...
        {
            return this.Equals(input as GoalBase);
        }

        /// <summary>
        /// Returns true if GoalBase instances are equal
        /// </summary>
        /// <param name="input">Instance of GoalBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GoalBase input)
        {
            if (input == null)
                return false;
