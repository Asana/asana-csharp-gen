...
namespace asana.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TagRequest :  IEquatable<TagRequest>, IValidatableObject
    {
        /// <summary>
        /// Color of the tag.
        /// </summary>
        ...
        {
            return this.Equals(input as TagRequest);
        }

        /// <summary>
        /// Returns true if TagRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of TagRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TagRequest input)
        {
            if (input == null)
                return false;
