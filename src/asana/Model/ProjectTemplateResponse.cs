...
namespace asana.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProjectTemplateResponse :  IEquatable<ProjectTemplateResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectTemplateResponse" /> class.
        /// </summary>
        ...
        public ProjectTemplateResponse(string name = default(string), string description = default(string), string htmlDescription = default(string), bool _public = default(bool), UserCompact owner = default(UserCompact), TeamCompact team = default(TeamCompact), ColorEnum? color = default(ColorEnum?))
        {
            this.Owner = owner;
            this.Color = color;
            this.Name = name;
        ...
        {
            return this.Equals(input as ProjectTemplateResponse);
        }

        /// <summary>
        /// Returns true if ProjectTemplateResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ProjectTemplateResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProjectTemplateResponse input)
        {
            if (input == null)
                return false;
