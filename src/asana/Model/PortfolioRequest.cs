...
namespace asana.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PortfolioRequest :  IEquatable<PortfolioRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public PortfolioRequest(string name = default(string), ColorEnum? color = default(ColorEnum?), string workspace = default(string), bool _public = default(bool))
        {
            this.Name = name;
            this.Color = color;
        ...
        {
            return this.Equals(input as PortfolioRequest);
        }

        /// <summary>
        /// Returns true if PortfolioRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PortfolioRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PortfolioRequest input)
        {
            if (input == null)
                return false;
