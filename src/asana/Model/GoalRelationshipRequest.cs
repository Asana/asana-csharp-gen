...
namespace asana.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GoalRelationshipRequest :  IEquatable<GoalRelationshipRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public GoalRelationshipRequest(ProjectCompact supportingResource = default(ProjectCompact), decimal contributionWeight = default(decimal), GoalCompact supportedGoal = default(GoalCompact))
        {
        ...
        {
            return this.Equals(input as GoalRelationshipRequest);
        }

        /// <summary>
        /// Returns true if GoalRelationshipRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GoalRelationshipRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GoalRelationshipRequest input)
        {
            if (input == null)
                return false;
