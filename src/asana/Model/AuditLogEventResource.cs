...
namespace asana.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AuditLogEventResource :  IEquatable<AuditLogEventResource>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as AuditLogEventResource);
        }

        /// <summary>
        /// Returns true if AuditLogEventResource instances are equal
        /// </summary>
        /// <param name="input">Instance of AuditLogEventResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuditLogEventResource input)
        {
            if (input == null)
                return false;
