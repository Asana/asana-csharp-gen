...
namespace asana.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WebhookRequestFiltersInner :  IEquatable<WebhookRequestFiltersInner>, IValidatableObject
    {
        /// <summary>
        ...
        public WebhookRequestFiltersInner(string resourceType = default(string), string resourceSubtype = default(string), string action = default(string), List<string> fields = default(List<string>))
        {
        ...
        {
            return this.Equals(input as WebhookRequestFiltersInner);
        }

        /// <summary>
        /// Returns true if WebhookRequestFiltersInner instances are equal
        /// </summary>
        /// <param name="input">Instance of WebhookRequestFiltersInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WebhookRequestFiltersInner input)
        {
            if (input == null)
                return false;
