...
namespace asana.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TagResponseAllOf :  IEquatable<TagResponseAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TagResponseAllOf" /> class.
        /// </summary>
        /// <param name="workspace">workspace.</param>
        public TagResponseAllOf(WorkspaceCompact workspace = default(WorkspaceCompact))
        {
        ...
        {
            return this.Equals(input as TagResponseAllOf);
        }

        /// <summary>
        /// Returns true if TagResponseAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of TagResponseAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TagResponseAllOf input)
        {
            if (input == null)
                return false;
