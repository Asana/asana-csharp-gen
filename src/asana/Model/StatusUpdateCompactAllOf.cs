...
namespace asana.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StatusUpdateCompactAllOf :  IEquatable<StatusUpdateCompactAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StatusUpdateCompactAllOf" /> class.
        /// </summary>
        /// <param name="title">The title of the status update..</param>
        public StatusUpdateCompactAllOf(string title = default(string))
        {
            this.Title = title;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StatusUpdateCompactAllOf {\n");
        ...
        {
            return this.Equals(input as StatusUpdateCompactAllOf);
        }

        /// <summary>
        /// Returns true if StatusUpdateCompactAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of StatusUpdateCompactAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StatusUpdateCompactAllOf input)
        {
            if (input == null)
                return false;
