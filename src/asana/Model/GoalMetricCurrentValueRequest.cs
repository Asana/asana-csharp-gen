...
namespace asana.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GoalMetricCurrentValueRequest :  IEquatable<GoalMetricCurrentValueRequest>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as GoalMetricCurrentValueRequest);
        }

        /// <summary>
        /// Returns true if GoalMetricCurrentValueRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GoalMetricCurrentValueRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GoalMetricCurrentValueRequest input)
        {
            if (input == null)
                return false;
