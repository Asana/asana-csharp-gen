...
namespace asana.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TimePeriodResponse :  IEquatable<TimePeriodResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TimePeriodResponse" /> class.
        /// </summary>
        ...
        public TimePeriodResponse(string endOn = default(string), string startOn = default(string), PeriodEnum? period = default(PeriodEnum?), string displayName = default(string), TimePeriodCompact parent = default(TimePeriodCompact))
        {
            this.EndOn = endOn;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TimePeriodResponse {\n");
        ...
        {
            return this.Equals(input as TimePeriodResponse);
        }

        /// <summary>
        /// Returns true if TimePeriodResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TimePeriodResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TimePeriodResponse input)
        {
            if (input == null)
                return false;
