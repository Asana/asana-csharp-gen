...
namespace asana.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AttachmentCompact :  IEquatable<AttachmentCompact>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as AttachmentCompact);
        }

        /// <summary>
        /// Returns true if AttachmentCompact instances are equal
        /// </summary>
        /// <param name="input">Instance of AttachmentCompact to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AttachmentCompact input)
        {
            if (input == null)
                return false;
