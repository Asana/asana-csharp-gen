...
namespace asana.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CustomFieldRequest :  IEquatable<CustomFieldRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public CustomFieldRequest(string name = default(string), ResourceSubtypeEnum? resourceSubtype = default(ResourceSubtypeEnum?), List<EnumOption> enumOptions = default(List<EnumOption>), bool enabled = default(bool), CustomFieldCompactAllOfDateValue dateValue = default(CustomFieldCompactAllOfDateValue), EnumOption enumValue = default(EnumOption), List<EnumOption> multiEnumValues = default(List<EnumOption>), decimal numberValue = default(decimal), string textValue = default(string), string description = default(string), int precision = default(int), FormatEnum? format = default(FormatEnum?), string currencyCode = default(string), string customLabel = default(string), CustomLabelPositionEnum? customLabelPosition = default(CustomLabelPositionEnum?), bool hasNotificationsEnabled = default(bool), string workspace = default(string), List<string> peopleValue = default(List<string>))
        {
            ...
            if (workspace == null)
            {
                throw new InvalidDataException("workspace is a required property for CustomFieldRequest and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as CustomFieldRequest);
        }

        /// <summary>
        /// Returns true if CustomFieldRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CustomFieldRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CustomFieldRequest input)
        {
            if (input == null)
                return false;
