...
namespace asana.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProjectBase :  IEquatable<ProjectBase>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ProjectBase);
        }

        /// <summary>
        /// Returns true if ProjectBase instances are equal
        /// </summary>
        /// <param name="input">Instance of ProjectBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProjectBase input)
        {
            if (input == null)
                return false;
