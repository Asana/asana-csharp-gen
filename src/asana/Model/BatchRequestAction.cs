...
namespace asana.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BatchRequestAction :  IEquatable<BatchRequestAction>, IValidatableObject
    {
        /// <summary>
        ...
        protected BatchRequestAction() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BatchRequestAction" /> class.
        /// </summary>
        /// <param name="relativePath">The path of the desired endpoint relative to the API’s base URL. Query parameters are not accepted here; put them in &#x60;data&#x60; instead. (required).</param>
        /// <param name="method">The HTTP method you wish to emulate for the action. (required).</param>
        /// <param name="data">For &#x60;GET&#x60; requests, this should be a map of query parameters you would have normally passed in the URL. Options and pagination are not accepted here; put them in &#x60;options&#x60; instead. For &#x60;POST&#x60;, &#x60;PATCH&#x60;, and &#x60;PUT&#x60; methods, this should be the content you would have normally put in the data field of the body..</param>
        /// <param name="options">options.</param>
        public BatchRequestAction(string relativePath = default(string), MethodEnum method = default(MethodEnum), Object data = default(Object), BatchRequestActionOptions options = default(BatchRequestActionOptions))
        {
            // to ensure "relativePath" is required (not null)
            if (relativePath == null)
            {
                throw new InvalidDataException("relativePath is a required property for BatchRequestAction and cannot be null");
            }
            else
            {
            ...
            if (method == null)
            {
                throw new InvalidDataException("method is a required property for BatchRequestAction and cannot be null");
            }
            else
            {
                this.Method = method;
        ...
        [DataMember(Name="relative_path", EmitDefaultValue=true)]
        ...
        {
            return this.Equals(input as BatchRequestAction);
        }

        /// <summary>
        /// Returns true if BatchRequestAction instances are equal
        /// </summary>
        /// <param name="input">Instance of BatchRequestAction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BatchRequestAction input)
        {
            if (input == null)
                return false;
