...
namespace asana.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class JobCompactAllOf :  IEquatable<JobCompactAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="JobCompactAllOf" /> class.
        /// </summary>
        ...
        public JobCompactAllOf(ProjectCompact newProject = default(ProjectCompact), TaskCompact newTask = default(TaskCompact), ProjectTemplateCompact newProjectTemplate = default(ProjectTemplateCompact))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class JobCompactAllOf {\n");
        ...
        {
            return this.Equals(input as JobCompactAllOf);
        }

        /// <summary>
        /// Returns true if JobCompactAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of JobCompactAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JobCompactAllOf input)
        {
            if (input == null)
                return false;
