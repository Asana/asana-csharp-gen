...
namespace asana.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProjectTemplateBase :  IEquatable<ProjectTemplateBase>, IValidatableObject
    {
        /// <summary>
        ...
        public ProjectTemplateBase(string name = default(string), string description = default(string), string htmlDescription = default(string), bool _public = default(bool), UserCompact owner = default(UserCompact), TeamCompact team = default(TeamCompact), ColorEnum? color = default(ColorEnum?))
        {
            this.Owner = owner;
            this.Color = color;
            this.Name = name;
        ...
        {
            return this.Equals(input as ProjectTemplateBase);
        }

        /// <summary>
        /// Returns true if ProjectTemplateBase instances are equal
        /// </summary>
        /// <param name="input">Instance of ProjectTemplateBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProjectTemplateBase input)
        {
            if (input == null)
                return false;
