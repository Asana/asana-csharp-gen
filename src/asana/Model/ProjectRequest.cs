...
namespace asana.Model
{
    ...
    public partial class ProjectRequest :  IEquatable<ProjectRequest>, IValidatableObject
    {
        ...
        public ProjectRequest(string name = default(string), bool archived = default(bool), ColorEnum? color = default(ColorEnum?), ProjectStatusResponse currentStatus = default(ProjectStatusResponse), StatusUpdateCompact currentStatusUpdate = default(StatusUpdateCompact), DefaultViewEnum? defaultView = default(DefaultViewEnum?), DateTime? dueDate = default(DateTime?), DateTime? dueOn = default(DateTime?), string htmlNotes = default(string), bool isTemplate = default(bool), string notes = default(string), bool _public = default(bool), DateTime? startOn = default(DateTime?), WorkspaceCompact workspace = default(WorkspaceCompact), Dictionary<string, string> customFields = default(Dictionary<string, string>), string followers = default(string), string owner = default(string), string team = default(string))
        {
            this.Color = color;
