...
namespace asana.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GoalRelationshipCompact :  IEquatable<GoalRelationshipCompact>, IValidatableObject
    {
        /// <summary>
        ...
        public GoalRelationshipCompact(ProjectCompact supportingResource = default(ProjectCompact), decimal contributionWeight = default(decimal))
        {
        ...
        {
            return this.Equals(input as GoalRelationshipCompact);
        }

        /// <summary>
        /// Returns true if GoalRelationshipCompact instances are equal
        /// </summary>
        /// <param name="input">Instance of GoalRelationshipCompact to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GoalRelationshipCompact input)
        {
            if (input == null)
                return false;
