...
namespace asana.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StoryBaseAllOf :  IEquatable<StoryBaseAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StoryBaseAllOf" /> class.
        /// </summary>
        ...
        public StoryBaseAllOf(string text = default(string), string htmlText = default(string), bool isPinned = default(bool), StickerNameEnum? stickerName = default(StickerNameEnum?))
        {
            this.Text = text;
        ...
        {
            return this.Equals(input as StoryBaseAllOf);
        }

        /// <summary>
        /// Returns true if StoryBaseAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of StoryBaseAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StoryBaseAllOf input)
        {
            if (input == null)
                return false;
