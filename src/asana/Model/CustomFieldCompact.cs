...
namespace asana.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CustomFieldCompact :  IEquatable<CustomFieldCompact>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as CustomFieldCompact);
        }

        /// <summary>
        /// Returns true if CustomFieldCompact instances are equal
        /// </summary>
        /// <param name="input">Instance of CustomFieldCompact to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CustomFieldCompact input)
        {
            if (input == null)
                return false;
