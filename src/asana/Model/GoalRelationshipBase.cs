...
namespace asana.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GoalRelationshipBase :  IEquatable<GoalRelationshipBase>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GoalRelationshipBase" /> class.
        /// </summary>
        ...
        public GoalRelationshipBase(ProjectCompact supportingResource = default(ProjectCompact), decimal contributionWeight = default(decimal), GoalCompact supportedGoal = default(GoalCompact))
        {
        ...
        {
            return this.Equals(input as GoalRelationshipBase);
        }

        /// <summary>
        /// Returns true if GoalRelationshipBase instances are equal
        /// </summary>
        /// <param name="input">Instance of GoalRelationshipBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GoalRelationshipBase input)
        {
            if (input == null)
                return false;
