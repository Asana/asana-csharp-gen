...
namespace asana.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TaskBaseAllOf :  IEquatable<TaskBaseAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TaskBaseAllOf" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as TaskBaseAllOf);
        }

        /// <summary>
        /// Returns true if TaskBaseAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of TaskBaseAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TaskBaseAllOf input)
        {
            if (input == null)
                return false;
