...
namespace asana.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PortfolioBase :  IEquatable<PortfolioBase>, IValidatableObject
    {
        /// <summary>
        ...
        public PortfolioBase(string name = default(string), ColorEnum? color = default(ColorEnum?))
        {
            this.Name = name;
            this.Color = color;
        }
        ...
        {
            return this.Equals(input as PortfolioBase);
        }

        /// <summary>
        /// Returns true if PortfolioBase instances are equal
        /// </summary>
        /// <param name="input">Instance of PortfolioBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PortfolioBase input)
        {
            if (input == null)
                return false;
