...
namespace asana.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StatusUpdateRequest :  IEquatable<StatusUpdateRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public StatusUpdateRequest(string title = default(string), string text = default(string), string htmlText = default(string), StatusTypeEnum statusType = default(StatusTypeEnum), string parent = default(string))
        {
            ...
            if (text == null)
            {
                throw new InvalidDataException("text is a required property for StatusUpdateRequest and cannot be null");
            }
            else
            {
                this.Text = text;
            ...
            if (statusType == null)
            {
                throw new InvalidDataException("statusType is a required property for StatusUpdateRequest and cannot be null");
            }
            else
            {
            ...
            if (parent == null)
            {
                throw new InvalidDataException("parent is a required property for StatusUpdateRequest and cannot be null");
            }
            else
            {
                this.Parent = parent;
        ...
        {
            return this.Equals(input as StatusUpdateRequest);
        }

        /// <summary>
        /// Returns true if StatusUpdateRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of StatusUpdateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StatusUpdateRequest input)
        {
            if (input == null)
                return false;
