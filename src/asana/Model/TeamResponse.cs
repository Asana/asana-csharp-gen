...
namespace asana.Model
{
    ...
    public partial class TeamResponse :  IEquatable<TeamResponse>, IValidatableObject
    {
        ...
        public TeamResponse(string name = default(string), string description = default(string), string htmlDescription = default(string), WorkspaceCompact organization = default(WorkspaceCompact), VisibilityEnum? visibility = default(VisibilityEnum?))
        {
            this.Name = name;
