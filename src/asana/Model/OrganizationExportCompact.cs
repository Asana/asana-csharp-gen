...
namespace asana.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrganizationExportCompact :  IEquatable<OrganizationExportCompact>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as OrganizationExportCompact);
        }

        /// <summary>
        /// Returns true if OrganizationExportCompact instances are equal
        /// </summary>
        /// <param name="input">Instance of OrganizationExportCompact to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrganizationExportCompact input)
        {
            if (input == null)
                return false;
