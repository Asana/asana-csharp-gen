...
namespace asana.Model
{
    ...
    public partial class TagResponse :  IEquatable<TagResponse>, IValidatableObject
    {
        ...
        public TagResponse(string name = default(string), ColorEnum? color = default(ColorEnum?), string notes = default(string), WorkspaceCompact workspace = default(WorkspaceCompact))
        {
            this.Color = color;
            this.Name = name;
            this.Color = color;
