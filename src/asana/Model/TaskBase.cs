...
namespace asana.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TaskBase :  IEquatable<TaskBase>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as TaskBase);
        }

        /// <summary>
        /// Returns true if TaskBase instances are equal
        /// </summary>
        /// <param name="input">Instance of TaskBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TaskBase input)
        {
            if (input == null)
                return false;
