...
namespace asana.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GoalMetricBase :  IEquatable<GoalMetricBase>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as GoalMetricBase);
        }

        /// <summary>
        /// Returns true if GoalMetricBase instances are equal
        /// </summary>
        /// <param name="input">Instance of GoalMetricBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GoalMetricBase input)
        {
            if (input == null)
                return false;
