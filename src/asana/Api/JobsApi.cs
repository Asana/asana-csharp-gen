...
namespace asana.Api
{
    ...
    public interface IJobsApi : IApiAccessor
    {
        ...
        GetJob200Response GetJob (string jobGid, bool? optPretty = default(bool?), List<string> optFields = default(List<string>));
        ...
        ApiResponse<GetJob200Response> GetJobWithHttpInfo (string jobGid, bool? optPretty = default(bool?), List<string> optFields = default(List<string>));
        ...
        System.Threading.Tasks.Task<GetJob200Response> GetJobAsync (string jobGid, bool? optPretty = default(bool?), List<string> optFields = default(List<string>), CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<GetJob200Response>> GetJobWithHttpInfoAsync (string jobGid, bool? optPretty = default(bool?), List<string> optFields = default(List<string>), CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class JobsApi : IJobsApi
    {
        ...
        /// <returns></returns>
        public JobsApi(asana.Client.Configuration configuration = null)
        {
        ...
        /// <param name="optFields">Defines fields to return. Some requests return *compact* representations of objects in order to conserve resources and complete the request more efficiently. Other times requests return more information than you may need. This option allows you to list the exact set of fields that the API should be sure to return for the objects. The field names should be provided as paths, described below. The id of included objects will always be returned, regardless of the field options. (optional)</param>
        /// <returns>GetJob200Response</returns>
        public GetJob200Response GetJob (string jobGid, bool? optPretty = default(bool?), List<string> optFields = default(List<string>))
        {
             ApiResponse<GetJob200Response> localVarResponse = GetJobWithHttpInfo(jobGid, optPretty, optFields);
        ...
        /// <param name="optFields">Defines fields to return. Some requests return *compact* representations of objects in order to conserve resources and complete the request more efficiently. Other times requests return more information than you may need. This option allows you to list the exact set of fields that the API should be sure to return for the objects. The field names should be provided as paths, described below. The id of included objects will always be returned, regardless of the field options. (optional)</param>
        /// <returns>ApiResponse of GetJob200Response</returns>
        public ApiResponse<GetJob200Response> GetJobWithHttpInfo (string jobGid, bool? optPretty = default(bool?), List<string> optFields = default(List<string>))
        {
            // verify the required parameter 'jobGid' is set
            if (jobGid == null)
                throw new ApiException(400, "Missing required parameter 'jobGid' when calling JobsApi->GetJob");

            var localVarPath = "/jobs/{job_gid}";
            ...
            if (jobGid != null) localVarPathParams.Add("job_gid", this.Configuration.ApiClient.ParameterToString(jobGid)); // path parameter
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of GetJob200Response</returns>
        public async System.Threading.Tasks.Task<GetJob200Response> GetJobAsync (string jobGid, bool? optPretty = default(bool?), List<string> optFields = default(List<string>), CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<GetJob200Response> localVarResponse = await GetJobWithHttpInfoAsync(jobGid, optPretty, optFields, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (GetJob200Response)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<GetJob200Response>> GetJobWithHttpInfoAsync (string jobGid, bool? optPretty = default(bool?), List<string> optFields = default(List<string>), CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'jobGid' is set
            if (jobGid == null)
                throw new ApiException(400, "Missing required parameter 'jobGid' when calling JobsApi->GetJob");
