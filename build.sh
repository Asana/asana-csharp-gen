...
${nuget_cmd} install src/asana/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/asana.dll"
...
then
  ...
  echo "[INFO] bin/asana.dll was created successfully"
fi
