...
> AddCustomFieldSettingForPortfolio200Response AddCustomFieldSettingForProject (string projectGid, AddCustomFieldSettingForPortfolioRequest addCustomFieldSettingForPortfolioRequest, bool? optPretty = null)
...
namespace Example
{
    public class AddCustomFieldSettingForProjectExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling ProjectsApi.AddCustomFieldSettingForProject: " + e.Message );
...
> CreateProject201Response AddFollowersForProject (string projectGid, AddFollowersForProjectRequest addFollowersForProjectRequest, bool? optPretty = null, List<string> optFields = null)
...
namespace Example
{
    public class AddFollowersForProjectExample
    {
        public static void Main()
        {
            Configuration.Default.BasePath = "https://app.asana.com/api/1.0";
            ...
            var apiInstance = new ProjectsApi(Configuration.Default);
            var projectGid = 1331;  // string | Globally unique identifier for the project.
            var addFollowersForProjectRequest = new AddFollowersForProjectRequest(); // AddFollowersForProjectRequest | Information about the followers being added.
            var optPretty = true;  // bool? | Provides “pretty” output. Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging. (optional) 
            ...
            {
                Debug.Print("Exception when calling ProjectsApi.AddFollowersForProject: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
> CreateProject201Response AddMembersForProject (string projectGid, AddMembersForPortfolioRequest addMembersForPortfolioRequest, bool? optPretty = null, List<string> optFields = null)
...
namespace Example
{
    public class AddMembersForProjectExample
    {
        public static void Main()
        {
            Configuration.Default.BasePath = "https://app.asana.com/api/1.0";
            ...
            {
                Debug.Print("Exception when calling ProjectsApi.AddMembersForProject: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
> CreateProject201Response CreateProject (CreateProjectRequest createProjectRequest, bool? optPretty = null, List<string> optFields = null)
...
namespace Example
{
    public class CreateProjectExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new ProjectsApi(Configuration.Default);
            var createProjectRequest = new CreateProjectRequest(); // CreateProjectRequest | The project to create.
            var optPretty = true;  // bool? | Provides “pretty” output. Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging. (optional) 
            var optFields = new List<string>(); // List<string> | Defines fields to return. Some requests return *compact* representations of objects in order to conserve resources and complete the request more efficiently. Other times requests return more information than you may need. This option allows you to list the exact set of fields that the API should be sure to return for the objects. The field names should be provided as paths, described below. The id of included objects will always be returned, regardless of the field options. (optional) 
...
> CreateProject201Response CreateProjectForTeam (string teamGid, CreateProjectRequest createProjectRequest, bool? optPretty = null, List<string> optFields = null)
...
namespace Example
{
    public class CreateProjectForTeamExample
    {
        public static void Main()
        {
            Configuration.Default.BasePath = "https://app.asana.com/api/1.0";
            ...
            var createProjectRequest = new CreateProjectRequest(); // CreateProjectRequest | The new project to create.
            var optPretty = true;  // bool? | Provides “pretty” output. Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging. (optional) 
            var optFields = new List<string>(); // List<string> | Defines fields to return. Some requests return *compact* representations of objects in order to conserve resources and complete the request more efficiently. Other times requests return more information than you may need. This option allows you to list the exact set of fields that the API should be sure to return for the objects. The field names should be provided as paths, described below. The id of included objects will always be returned, regardless of the field options. (optional) 
            ...
            {
                Debug.Print("Exception when calling ProjectsApi.CreateProjectForTeam: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
> CreateProject201Response CreateProjectForWorkspace (string workspaceGid, CreateProjectRequest createProjectRequest, bool? optPretty = null, List<string> optFields = null)
...
namespace Example
{
    public class CreateProjectForWorkspaceExample
    {
        public static void Main()
        {
            Configuration.Default.BasePath = "https://app.asana.com/api/1.0";
            ...
            {
                Debug.Print("Exception when calling ProjectsApi.CreateProjectForWorkspace: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
> DeleteAttachment200Response DeleteProject (string projectGid, bool? optPretty = null, List<string> optFields = null)
...
> GetJob200Response DuplicateProject (string projectGid, bool? optPretty = null, List<string> optFields = null, DuplicateProjectRequest duplicateProjectRequest = null)
...
namespace Example
{
    public class DuplicateProjectExample
    {
        public static void Main()
        {
            ...
            var optPretty = true;  // bool? | Provides “pretty” output. Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging. (optional) 
            var optFields = new List<string>(); // List<string> | Defines fields to return. Some requests return *compact* representations of objects in order to conserve resources and complete the request more efficiently. Other times requests return more information than you may need. This option allows you to list the exact set of fields that the API should be sure to return for the objects. The field names should be provided as paths, described below. The id of included objects will always be returned, regardless of the field options. (optional) 
            var duplicateProjectRequest = new DuplicateProjectRequest(); // DuplicateProjectRequest | Describes the duplicate's name and the elements that will be duplicated. (optional) 
            ...
            {
                Debug.Print("Exception when calling ProjectsApi.DuplicateProject: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
> CreateProject201Response GetProject (string projectGid, bool? optPretty = null, List<string> optFields = null)
...
> GetItemsForPortfolio200Response GetProjects (bool? optPretty = null, List<string> optFields = null, int? limit = null, string offset = null, string workspace = null, string team = null, bool? archived = null)
...
namespace Example
{
    public class GetProjectsExample
    {
        public static void Main()
        {
            ...
            var workspace = 1331;  // string | The workspace or organization to filter projects on. (optional) 
            var team = 14916;  // string | The team to filter projects on. (optional) 
            var archived = false;  // bool? | Only return projects whose `archived` field takes on the value of this parameter. (optional) 
...
> GetItemsForPortfolio200Response GetProjectsForTask (string taskGid, bool? optPretty = null, List<string> optFields = null, int? limit = null, string offset = null)
...
namespace Example
{
    public class GetProjectsForTaskExample
    {
        public static void Main()
        {
            Configuration.Default.BasePath = "https://app.asana.com/api/1.0";
            ...
            {
                Debug.Print("Exception when calling ProjectsApi.GetProjectsForTask: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
> GetItemsForPortfolio200Response GetProjectsForTeam (string teamGid, bool? optPretty = null, List<string> optFields = null, int? limit = null, string offset = null, bool? archived = null)
...
namespace Example
{
    public class GetProjectsForTeamExample
    {
        public static void Main()
        {
            Configuration.Default.BasePath = "https://app.asana.com/api/1.0";
            ...
            {
                Debug.Print("Exception when calling ProjectsApi.GetProjectsForTeam: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
> GetItemsForPortfolio200Response GetProjectsForWorkspace (string workspaceGid, bool? optPretty = null, List<string> optFields = null, int? limit = null, string offset = null, bool? archived = null)
...
namespace Example
{
    public class GetProjectsForWorkspaceExample
    {
        public static void Main()
        {
            Configuration.Default.BasePath = "https://app.asana.com/api/1.0";
            ...
            {
                Debug.Print("Exception when calling ProjectsApi.GetProjectsForWorkspace: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
> GetTaskCountsForProject200Response GetTaskCountsForProject (string projectGid, bool? optPretty = null, List<string> optFields = null, int? limit = null, string offset = null)
...
namespace Example
{
    public class GetTaskCountsForProjectExample
    {
        public static void Main()
        {
            Configuration.Default.BasePath = "https://app.asana.com/api/1.0";
            ...
            {
                Debug.Print("Exception when calling ProjectsApi.GetTaskCountsForProject: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
> GetJob200Response ProjectSaveAsTemplate (string projectGid, ProjectSaveAsTemplateRequest projectSaveAsTemplateRequest, bool? optPretty = null, List<string> optFields = null)
...
namespace Example
{
    public class ProjectSaveAsTemplateExample
    {
        public static void Main()
        {
            Configuration.Default.BasePath = "https://app.asana.com/api/1.0";
            ...
            var apiInstance = new ProjectsApi(Configuration.Default);
            var projectGid = 1331;  // string | Globally unique identifier for the project.
            var projectSaveAsTemplateRequest = new ProjectSaveAsTemplateRequest(); // ProjectSaveAsTemplateRequest | Describes the inputs used for creating a project template, such as the resulting project template's name, which team it should be created in.
            var optPretty = true;  // bool? | Provides “pretty” output. Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging. (optional) 
            var optFields = new List<string>(); // List<string> | Defines fields to return. Some requests return *compact* representations of objects in order to conserve resources and complete the request more efficiently. Other times requests return more information than you may need. This option allows you to list the exact set of fields that the API should be sure to return for the objects. The field names should be provided as paths, described below. The id of included objects will always be returned, regardless of the field options. (optional) 
            ...
            {
                Debug.Print("Exception when calling ProjectsApi.ProjectSaveAsTemplate: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
> DeleteAttachment200Response RemoveCustomFieldSettingForProject (string projectGid, RemoveCustomFieldSettingForPortfolioRequest removeCustomFieldSettingForPortfolioRequest, bool? optPretty = null)
...
namespace Example
{
    public class RemoveCustomFieldSettingForProjectExample
    {
        public static void Main()
        {
            Configuration.Default.BasePath = "https://app.asana.com/api/1.0";
            ...
            {
                Debug.Print("Exception when calling ProjectsApi.RemoveCustomFieldSettingForProject: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
> CreateProject201Response RemoveFollowersForProject (string projectGid, RemoveFollowersForProjectRequest removeFollowersForProjectRequest, bool? optPretty = null, List<string> optFields = null)
...
namespace Example
{
    public class RemoveFollowersForProjectExample
    {
        public static void Main()
        {
            Configuration.Default.BasePath = "https://app.asana.com/api/1.0";
            ...
            var apiInstance = new ProjectsApi(Configuration.Default);
            var projectGid = 1331;  // string | Globally unique identifier for the project.
            var removeFollowersForProjectRequest = new RemoveFollowersForProjectRequest(); // RemoveFollowersForProjectRequest | Information about the followers being removed.
            var optPretty = true;  // bool? | Provides “pretty” output. Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging. (optional) 
            var optFields = new List<string>(); // List<string> | Defines fields to return. Some requests return *compact* representations of objects in order to conserve resources and complete the request more efficiently. Other times requests return more information than you may need. This option allows you to list the exact set of fields that the API should be sure to return for the objects. The field names should be provided as paths, described below. The id of included objects will always be returned, regardless of the field options. (optional) 
            ...
            {
                Debug.Print("Exception when calling ProjectsApi.RemoveFollowersForProject: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
> CreateProject201Response RemoveMembersForProject (string projectGid, RemoveMembersForPortfolioRequest removeMembersForPortfolioRequest, bool? optPretty = null, List<string> optFields = null)
...
namespace Example
{
    public class RemoveMembersForProjectExample
    {
        public static void Main()
        {
            Configuration.Default.BasePath = "https://app.asana.com/api/1.0";
            ...
            {
                Debug.Print("Exception when calling ProjectsApi.RemoveMembersForProject: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
> CreateProject201Response UpdateProject (string projectGid, CreateProjectRequest createProjectRequest, bool? optPretty = null, List<string> optFields = null)
...
namespace Example
{
    public class UpdateProjectExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new ProjectsApi(Configuration.Default);
            var projectGid = 1331;  // string | Globally unique identifier for the project.
            var createProjectRequest = new CreateProjectRequest(); // CreateProjectRequest | The updated fields for the project.
            var optPretty = true;  // bool? | Provides “pretty” output. Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging. (optional) 
            var optFields = new List<string>(); // List<string> | Defines fields to return. Some requests return *compact* representations of objects in order to conserve resources and complete the request more efficiently. Other times requests return more information than you may need. This option allows you to list the exact set of fields that the API should be sure to return for the objects. The field names should be provided as paths, described below. The id of included objects will always be returned, regardless of the field options. (optional) 
