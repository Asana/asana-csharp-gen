...
> GetProjectStatus200Response CreateProjectStatusForProject (string projectGid, CreateProjectStatusForProjectRequest createProjectStatusForProjectRequest, bool? optPretty = null, List<string> optFields = null)
...
namespace Example
{
    public class CreateProjectStatusForProjectExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new ProjectStatusesApi(Configuration.Default);
            var projectGid = 1331;  // string | Globally unique identifier for the project.
            var createProjectStatusForProjectRequest = new CreateProjectStatusForProjectRequest(); // CreateProjectStatusForProjectRequest | The project status to create.
            ...
            {
                // Create a project status
                GetProjectStatus200Response result = apiInstance.CreateProjectStatusForProject(projectGid, createProjectStatusForProjectRequest, optPretty, optFields);
                Debug.WriteLine(result);
            }
            catch (ApiException e)
            {
                Debug.Print("Exception when calling ProjectStatusesApi.CreateProjectStatusForProject: " + e.Message );
...
> DeleteAttachment200Response DeleteProjectStatus (string projectStatusGid, bool? optPretty = null, List<string> optFields = null)
...
namespace Example
{
    public class DeleteProjectStatusExample
    {
        public static void Main()
        {
            Configuration.Default.BasePath = "https://app.asana.com/api/1.0";
            ...
            {
                // Delete a project status
                DeleteAttachment200Response result = apiInstance.DeleteProjectStatus(projectStatusGid, optPretty, optFields);
                Debug.WriteLine(result);
            }
            catch (ApiException e)
            {
                Debug.Print("Exception when calling ProjectStatusesApi.DeleteProjectStatus: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
> GetProjectStatus200Response GetProjectStatus (string projectStatusGid, bool? optPretty = null, List<string> optFields = null)
...
namespace Example
{
    public class GetProjectStatusExample
    {
        public static void Main()
        {
            ...
            {
                // Get a project status
                GetProjectStatus200Response result = apiInstance.GetProjectStatus(projectStatusGid, optPretty, optFields);
                Debug.WriteLine(result);
            }
            catch (ApiException e)
            {
                Debug.Print("Exception when calling ProjectStatusesApi.GetProjectStatus: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
> GetProjectStatusesForProject200Response GetProjectStatusesForProject (string projectGid, bool? optPretty = null, List<string> optFields = null, int? limit = null, string offset = null)
...
namespace Example
{
    public class GetProjectStatusesForProjectExample
    {
        public static void Main()
        {
            Configuration.Default.BasePath = "https://app.asana.com/api/1.0";
            ...
            {
                // Get statuses from a project
                GetProjectStatusesForProject200Response result = apiInstance.GetProjectStatusesForProject(projectGid, optPretty, optFields, limit, offset);
                Debug.WriteLine(result);
            }
            catch (ApiException e)
            {
                Debug.Print("Exception when calling ProjectStatusesApi.GetProjectStatusesForProject: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
