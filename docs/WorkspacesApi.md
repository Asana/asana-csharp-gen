...
namespace Example
{
    public class AddUserForWorkspaceExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new WorkspacesApi(Configuration.Default);
...
> GetWorkspaces200Response GetWorkspaces (bool? optPretty = null, List<string> optFields = null, int? limit = null, string offset = null)
...
namespace Example
{
    public class GetWorkspacesExample
    {
        public static void Main()
        {
            ...
            {
                // Get multiple workspaces
                GetWorkspaces200Response result = apiInstance.GetWorkspaces(optPretty, optFields, limit, offset);
                Debug.WriteLine(result);
            }
            catch (ApiException e)
            {
...
> DeleteAttachment200Response RemoveUserForWorkspace (string workspaceGid, RemoveUserForWorkspaceRequest removeUserForWorkspaceRequest, bool? optPretty = null, List<string> optFields = null)
...
namespace Example
{
    public class RemoveUserForWorkspaceExample
    {
        public static void Main()
        {
            ...
            {
                // Remove a user from a workspace or organization
                DeleteAttachment200Response result = apiInstance.RemoveUserForWorkspace(workspaceGid, removeUserForWorkspaceRequest, optPretty, optFields);
                Debug.WriteLine(result);
            }
            catch (ApiException e)
            {
