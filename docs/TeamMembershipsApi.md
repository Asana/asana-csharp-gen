...
namespace Example
{
    public class GetTeamMembershipExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new TeamMembershipsApi(Configuration.Default);
            var teamMembershipGid = 724362;  // string | 
            ...
            {
                // Get a team membership
                GetTeamMembership200Response result = apiInstance.GetTeamMembership(teamMembershipGid, optPretty, optFields);
                Debug.WriteLine(result);
            }
            catch (ApiException e)
            {
                Debug.Print("Exception when calling TeamMembershipsApi.GetTeamMembership: " + e.Message );
...
> GetTeamMemberships200Response GetTeamMemberships (bool? optPretty = null, List<string> optFields = null, int? limit = null, string offset = null, string team = null, string user = null, string workspace = null)
...
namespace Example
{
    public class GetTeamMembershipsExample
    {
        public static void Main()
        {
            Configuration.Default.BasePath = "https://app.asana.com/api/1.0";
            ...
            var team = 159874;  // string | Globally unique identifier for the team. (optional) 
            var user = 512241;  // string | A string identifying a user. This can either be the string \"me\", an email, or the gid of a user. This parameter must be used with the workspace parameter. (optional) 
            var workspace = 31326;  // string | Globally unique identifier for the workspace. This parameter must be used with the user parameter. (optional) 

            try
            {
                // Get team memberships
                GetTeamMemberships200Response result = apiInstance.GetTeamMemberships(optPretty, optFields, limit, offset, team, user, workspace);
                Debug.WriteLine(result);
            }
            catch (ApiException e)
            {
                Debug.Print("Exception when calling TeamMembershipsApi.GetTeamMemberships: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
> GetTeamMemberships200Response GetTeamMembershipsForTeam (string teamGid, bool? optPretty = null, List<string> optFields = null, int? limit = null, string offset = null)
...
namespace Example
{
    public class GetTeamMembershipsForTeamExample
    {
        public static void Main()
        {
            Configuration.Default.BasePath = "https://app.asana.com/api/1.0";
            ...
            {
                // Get memberships from a team
                GetTeamMemberships200Response result = apiInstance.GetTeamMembershipsForTeam(teamGid, optPretty, optFields, limit, offset);
                Debug.WriteLine(result);
            }
            catch (ApiException e)
            {
                Debug.Print("Exception when calling TeamMembershipsApi.GetTeamMembershipsForTeam: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
> GetTeamMemberships200Response GetTeamMembershipsForUser (string userGid, string workspace, bool? optPretty = null, List<string> optFields = null, int? limit = null, string offset = null)
...
namespace Example
{
    public class GetTeamMembershipsForUserExample
    {
        public static void Main()
        {
            Configuration.Default.BasePath = "https://app.asana.com/api/1.0";
            ...
            {
                // Get memberships from a user
                GetTeamMemberships200Response result = apiInstance.GetTeamMembershipsForUser(userGid, workspace, optPretty, optFields, limit, offset);
                Debug.WriteLine(result);
            }
            catch (ApiException e)
            {
                Debug.Print("Exception when calling TeamMembershipsApi.GetTeamMembershipsForUser: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
