...
namespace Example
{
    public class AddFollowersExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new GoalsApi(Configuration.Default);
...
> GetGoal200Response CreateGoal (UpdateGoalRequest updateGoalRequest, bool? optPretty = null, List<string> optFields = null, int? limit = null, string offset = null)
...
namespace Example
{
    public class CreateGoalExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new GoalsApi(Configuration.Default);
            var updateGoalRequest = new UpdateGoalRequest(); // UpdateGoalRequest | The goal to create.
            var optPretty = true;  // bool? | Provides “pretty” output. Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging. (optional) 
            var optFields = new List<string>(); // List<string> | Defines fields to return. Some requests return *compact* representations of objects in order to conserve resources and complete the request more efficiently. Other times requests return more information than you may need. This option allows you to list the exact set of fields that the API should be sure to return for the objects. The field names should be provided as paths, described below. The id of included objects will always be returned, regardless of the field options. (optional) 
            ...
            {
                // Create a goal
                GetGoal200Response result = apiInstance.CreateGoal(updateGoalRequest, optPretty, optFields, limit, offset);
                Debug.WriteLine(result);
            }
            catch (ApiException e)
            {
...
> DeleteAttachment200Response DeleteGoal (string goalGid, bool? optPretty = null, List<string> optFields = null)
...
namespace Example
{
    public class DeleteGoalExample
    {
        public static void Main()
        {
            ...
            {
                // Delete a goal
                DeleteAttachment200Response result = apiInstance.DeleteGoal(goalGid, optPretty, optFields);
                Debug.WriteLine(result);
            }
            catch (ApiException e)
            {
...
> GetGoals200Response GetGoals (bool? optPretty = null, List<string> optFields = null, int? limit = null, string offset = null, string portfolio = null, string project = null, bool? isWorkspaceLevel = null, string team = null, string workspace = null, List<string> timePeriods = null)
...
namespace Example
{
    public class GetGoalsExample
    {
        public static void Main()
        {
            ...
            {
                // Get goals
                GetGoals200Response result = apiInstance.GetGoals(optPretty, optFields, limit, offset, portfolio, project, isWorkspaceLevel, team, workspace, timePeriods);
                Debug.WriteLine(result);
            }
            catch (ApiException e)
            {
...
> GetGoals200Response GetParentGoalsForGoal (string goalGid, bool? optPretty = null, List<string> optFields = null)
...
namespace Example
{
    public class GetParentGoalsForGoalExample
    {
        public static void Main()
        {
            ...
            {
                // Get parent goals from a goal
                GetGoals200Response result = apiInstance.GetParentGoalsForGoal(goalGid, optPretty, optFields);
                Debug.WriteLine(result);
            }
            catch (ApiException e)
            {
