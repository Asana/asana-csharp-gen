...
> DeleteAttachment200Response AddTaskForSection (string sectionGid, AddTaskForSectionRequest addTaskForSectionRequest, bool? optPretty = null, List<string> optFields = null)
...
namespace Example
{
    public class AddTaskForSectionExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new SectionsApi(Configuration.Default);
            var sectionGid = 321654;  // string | The globally unique identifier for the section.
            var addTaskForSectionRequest = new AddTaskForSectionRequest(); // AddTaskForSectionRequest | The task and optionally the insert location.
            ...
            {
                Debug.Print("Exception when calling SectionsApi.AddTaskForSection: " + e.Message );
...
> GetSection200Response CreateSectionForProject (string projectGid, UpdateSectionRequest updateSectionRequest, bool? optPretty = null, List<string> optFields = null)
...
namespace Example
{
    public class CreateSectionForProjectExample
    {
        public static void Main()
        {
            Configuration.Default.BasePath = "https://app.asana.com/api/1.0";
            ...
            var updateSectionRequest = new UpdateSectionRequest(); // UpdateSectionRequest | The section to create.
            var optPretty = true;  // bool? | Provides “pretty” output. Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging. (optional) 
            var optFields = new List<string>(); // List<string> | Defines fields to return. Some requests return *compact* representations of objects in order to conserve resources and complete the request more efficiently. Other times requests return more information than you may need. This option allows you to list the exact set of fields that the API should be sure to return for the objects. The field names should be provided as paths, described below. The id of included objects will always be returned, regardless of the field options. (optional) 
            ...
            {
                // Create a section in a project
                GetSection200Response result = apiInstance.CreateSectionForProject(projectGid, updateSectionRequest, optPretty, optFields);
                Debug.WriteLine(result);
            }
            catch (ApiException e)
            {
                Debug.Print("Exception when calling SectionsApi.CreateSectionForProject: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
> DeleteAttachment200Response DeleteSection (string sectionGid, bool? optPretty = null, List<string> optFields = null)
...
> GetSection200Response GetSection (string sectionGid, bool? optPretty = null, List<string> optFields = null)
...
namespace Example
{
    public class GetSectionExample
    {
        public static void Main()
        {
            ...
            {
                // Get a section
                GetSection200Response result = apiInstance.GetSection(sectionGid, optPretty, optFields);
                Debug.WriteLine(result);
            }
            catch (ApiException e)
            {
...
> GetSectionsForProject200Response GetSectionsForProject (string projectGid, bool? optPretty = null, List<string> optFields = null, int? limit = null, string offset = null)
...
namespace Example
{
    public class GetSectionsForProjectExample
    {
        public static void Main()
        {
            Configuration.Default.BasePath = "https://app.asana.com/api/1.0";
            ...
            {
                Debug.Print("Exception when calling SectionsApi.GetSectionsForProject: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
> DeleteAttachment200Response InsertSectionForProject (string projectGid, InsertSectionForProjectRequest insertSectionForProjectRequest, bool? optPretty = null, List<string> optFields = null)
...
namespace Example
{
    public class InsertSectionForProjectExample
    {
        public static void Main()
        {
            Configuration.Default.BasePath = "https://app.asana.com/api/1.0";
            ...
            var apiInstance = new SectionsApi(Configuration.Default);
            var projectGid = 1331;  // string | Globally unique identifier for the project.
            var insertSectionForProjectRequest = new InsertSectionForProjectRequest(); // InsertSectionForProjectRequest | The section's move action.
            var optPretty = true;  // bool? | Provides “pretty” output. Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging. (optional) 
            var optFields = new List<string>(); // List<string> | Defines fields to return. Some requests return *compact* representations of objects in order to conserve resources and complete the request more efficiently. Other times requests return more information than you may need. This option allows you to list the exact set of fields that the API should be sure to return for the objects. The field names should be provided as paths, described below. The id of included objects will always be returned, regardless of the field options. (optional) 
            ...
            {
                Debug.Print("Exception when calling SectionsApi.InsertSectionForProject: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
> GetSection200Response UpdateSection (string sectionGid, UpdateSectionRequest updateSectionRequest, bool? optPretty = null, List<string> optFields = null)
...
namespace Example
{
    public class UpdateSectionExample
    {
        public static void Main()
        {
            ...
            {
                // Update a section
                GetSection200Response result = apiInstance.UpdateSection(sectionGid, updateSectionRequest, optPretty, optFields);
                Debug.WriteLine(result);
            }
            catch (ApiException e)
            {
